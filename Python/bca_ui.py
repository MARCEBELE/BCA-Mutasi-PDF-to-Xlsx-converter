...
# sys._MEIPASS is the temp folder where PyInstaller extracts bundled files at runtime.
...
class App(tk.Tk):
    ...
    def _enable_drop(self):
        """Enable Windows drag-and-drop via windnd. Falls back gracefully if not installed."""
